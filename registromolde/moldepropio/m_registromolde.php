    ...
    class m_registrarmolde 
    {
        ...
        { 
            ...
            try {
                ...
                VALUES('$idmolde','$nombre','$medida','$estado','$usuario','P')");
                $query->execute();
                foreach ($productos->tds as $dato){
                        ...
                        VALUES('$idmolde','$dato[0]','$dato[1]','$dato[2]','$usuario')");
                        $query2->execute(); 
        ...
        {
            try {
                $query = $this->bd->prepare("SELECT * FROM T_MOLDE where TIPO_MOLDE <> 'E'");
                $query->execute();
                $datos = $query->fetchAll();
                return $datos;
            } catch (Exception $e) {
        ...
        public function m_actualizamolde($idmolde,$nombre,$medida,$estado,$productos,$usuario)
        {
            ...
            try {
                ...
                foreach ($productos->tds as $dato){
                        ...
                        ='$dato[1]',UNI_MEDIDA = '$dato[2]',USU_MODIFICO = '$usuario', FEC_MODIFICO = GETDATE() WHERE
