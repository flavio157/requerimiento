...
$(document).ready(function () {
    ...
    $("#txtprodcant").blur(function(){
        ...
        for (let l = 0; l < td.length; l++) {
            ...
            if($(td[l]).find("td")[6].innerHTML == '0'){
                cant = $(td[l]).find("td")[4].innerHTML;
                quitarfila($(td[l]).find("td")[0].innerHTML); /*110*16/120*/
                $(td[l]).find("td")[2].innerHTML = parseFloat(Number($(this).val()) * Number(cant) /Number(canform)).toFixed(2)
...
function createtable(obj) {
    ...
    $.each(obj, function(i, item) {
        ...
        var fila2 ='';
        fila2 +="<td class='tdcontent'>"+item[1]+"</td>";
        fila2 +="<td class='tdcontent'>"+item[1]+"</td>";
        fila2 +="<td >"+item[2]+"</td>";
        fila2 +="<td class='tdcontent'>"+Number(item[3]).toFixed(2)+"</td>";
