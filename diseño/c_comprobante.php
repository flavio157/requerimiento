...
require_once("m_comprobante.php");
    ...
    if($accion == 'personal'){
        ...
        c_comprobante::c_guardarcompro($fechemision,$fechentrega,$codpersonal
                        ...
                        $observacio,$usuregistro,$almacen,$productos,$nrocompro,$correlativo);
    ...
    class c_comprobante
    {
        ...
        static function guardarproducto($codpro,$codcateg,$despro,$unimedpro,$stockmin,$abre,$usuregi,$pesoneto,$codclase,$oficina){
            ...
            if(strlen($unimedpro) > 10){print_r("Error maximo 10 caracteres"); return;}
            ...
            if(count(count_chars($unimedpro, 1)) == 1){print_r("Error unidad de medida invalido");return;}
        ...
        static function validarserieprod($nroseriepro){
            $array = ['123456789','123456','987654321','abcd','abcdef',];
        ...
        static function c_guardarcompro($fechemision,$fechentrega,$codpersonal
                  ...
                  $usuregistro,$almacen,$productos,$nrocompro,$correlativo){
            ...
            $consulta = "NRO_COMPROBANTE = '$nrocompro' and CORREL_COMPROBANTE = '$correlativo' and TIPO_COMPROBANTE = '$tipocomprob'";
            ...
            $c_guardarprod = $m_producto->m_guardarcompr($fechemision,$fechentrega,$codpersonal
                        ...
                        $usuregistro,$almacen,$productos,$total,$nrocompro,$correlativo);
