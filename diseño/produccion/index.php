   ...
   <section>  
        <div class="main"> 
          <form style="margin-bottom: 0px;" id="frmproduccion">
                  <input type="text" id="vroficina" style="display: none;" value="<?php echo 'Smp2'//echo $ofi?>"/>
                  <input type="text" id="vrzona" style="display: none;" value="<?php ''//echo  $zon?>"/>
                  <input type="text" id="vrcodpersonal" style="display: none;" value="<?php echo '0215'//echo  $cod?>"/>
      ...
      <div class="modal-dialog">
        ...
        <div class="modal-body">
          <div class="row">
            <div class="col">
              <label >Insumo</label>
              <input type="text" id="mdinsumo" name="mdinsumo" class="form-control" disabled>
            </div>
          </div>
          <div class="row">
            <div class="col">
            ...
            <div class="col">
              <label >Stok</label>
              <input type="number" id="mdstock" name="mdstock" class="form-control" disabled>
            </div>
          </div>
          <div class="row">
              <div class="col">
        ...
        <div class="modal-footer">
          <button type="button" id="btncancelar" class="btn btn-danger" data-bs-dismiss="modal">Cerrar</button>         
          <button type="button" id="btnactuitems" class="btn btn-primary">Aceptar</button>
        </div>
        </div>
      </div>
    </div>
