...
<head>
    ...
    <script src="./js/jsreporteproduccion.js"></script>
...
<body style="background: #f5f5f5;">
   <header>
        <title>Lista de producciónes</title>
   </header>
   <section>
        <div class="main"> 
          <form style="margin-bottom: 0px;" id="frmproduccion">
                  ...
                  <div class="row mb-3">
                      <div class="col">
                          <center><label class="titulos">Lista de produccion general</label></center>
                      </div>
                  </div>
                  <div class="row mb-3">
                      <div class="col-md-4">
                      ...
                      <div class="col-md-4">
                          ...
                          <div class="input-group mb-3">
                             <input type="text" id="txtcodpor" style="display: none;">
                              <input type="text" id="txtsugeprodu" class="form-control mayu" >
                              <a class="btn btn-success" id="btnbuscaproduc">
