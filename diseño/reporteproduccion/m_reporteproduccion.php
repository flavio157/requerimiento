...
class m_reporteproduccion
{
    ...
    public function m_buscar($tabla,$dato)
    {
      ...
      public function m_r_avances($codgen,$produccion,$producto,$cantidad,$usu)
    {
        $hora = gethora();
        $maquina = os_info();
        ...
        if(count($m_producto) > 0){
            ...
            if(count($m_avances) > 0){
                ...
                $query->execute();
                $cantidad = $m_avances[0][6] * $m_avances[0][7];
                ...
                return "codigo del avance no encontrado";
            }
        }else{
