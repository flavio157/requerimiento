...
<html>
    <head>
        ...
        <script type="text/javascript" src="../js/jsllamadaOfi.js"></script>
    ...
    <div class="main">
       ...
       <?php include("../Vista/M_Reprogramar.php"); ?>
       <?php include("../Vista/M_Mensaje.php"); ?>
